...
<head>
    ...
    <title>Got World - Admin Panel</title>
    <!-- plugins:css -->
                ...
                <div class="profile-desc">
                    <div class="profile-pic">
                        ...
                        <div class="profile-name">
                            <h5 class="mb-0 font-weight-normal">Mohammad Rostami</h5>
...
{{--            characters section--}}
            <li class="nav-item menu-items">
                <a class="nav-link" data-toggle="collapse" href="#characters-submenu" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
                    <span class="menu-title">کاراکتر ها</span>
...
{{--            Houses section--}}
            <li class="nav-item menu-items">
                <a class="nav-link" data-toggle="collapse" href="#houses-submenu" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
                    <span class="menu-title">خاندان ها</span>
                    <i class="menu-arrow"></i>
                </a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                            <div class="navbar-profile">
                                <img class="img-xs rounded-circle" src="assets/images/faces/face15.jpg" alt="">
                                <p class="mb-0 d-none d-sm-block navbar-profile-name">Mohamamd Rostami</p>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="pl-2">Mohammad Rostami</span>
                                            </td>
                                            <td> 02312 </td>
                                            <td> $14,500 </td>
                                            <td> Dashboard </td>
